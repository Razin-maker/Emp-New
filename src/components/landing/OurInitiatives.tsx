...
const isEmp = (item: Initiative) =>
    item.id === 'emp' || item.name.toLowerCase().includes('emp');
...
const DesktopOurInitiatives = ({ initiatives }: { initiatives: Initiative[] }) => {
    ...
    return (
        <section id="initiatives" className="section-padding bg-secondary/30 relative overflow-hidden">
